  ...
  return (
    <section className="space-y-6">
      <div className="luxury-panel">
        <p className="text-sm font-black uppercase tracking-normal text-gold-300">TEAMS &amp; STORES</p>
        <h1 className="mt-2 text-3xl font-black text-white">團隊＆店名管理</h1>
        <p className="mt-3 text-base leading-7 text-slate-200">管理各團隊、店名、品牌據點與前台顯示分類。</p>
      </div>
