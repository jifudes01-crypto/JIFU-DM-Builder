...
export function UnifiedWorkspaceClient({ teams, templates, contacts }: UnifiedWorkspaceClientProps) {
        ...
        <section>
          ...
          {data.teams.length ? (
            ...
            <div className="card p-6">
              <h3 className="text-xl font-black text-navy-900">尚未建立團隊</h3>
              <p className="section-subtitle">請切換到管理後台，先新增或匯入團隊。</p>
            </div>
          )}
        </section>
      ) : (
